...
CLOSE_AFTER = int(input("ENTER TIME IN SECONDS (MIN 12)  "  )) # время указывается в секундах
...
if CLOSE_AFTER > 60: # Если число больше то выполняет команду ниже
	print('ERROR THE VALUE CANNOT BE MORE THAN 60!')
	exit()
